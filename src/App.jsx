...
function App() {
  ...
  return <main>
    ...
    <section className="hero" id="top">
      <div><p className="eyebrow">SMR PROJECT READINESS + EVIDENCE CONTROL</p><h1>Know what is ready. Know what is missing. Know what must happen next.</h1><p className="hero-copy">Atlas Nuclear helps organizations evaluate SMR project readiness, connect requirements to evidence, identify critical gaps, and build a defensible plan for the next project decision.</p><div className="actions"><a className="button primary" href={DEMO}>Run the guided demonstration</a><a className="button secondary" href="#how">See how Atlas works</a></div><p className="supporting">Built for prospective owners and operators, utilities, developers, industrial users, data-center projects, investors, lenders, and major suppliers.</p></div>
